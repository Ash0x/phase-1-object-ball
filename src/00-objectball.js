...
//variablese for teams and all players
...
const teamColors = (teamName) => {
	if (gameObject().home.teamName === teamName) return gameObject().home.colors
...
const teamName = () => {
	...
	for (let team in gameObject()) {
		resultArray.push(gameObject()[team].teamName)
	}
	return resultArray
}

const teamNumbers = (teamName) => {
	const resultArray = []
	//similar to teamColors, but needs to loop through the team's players
